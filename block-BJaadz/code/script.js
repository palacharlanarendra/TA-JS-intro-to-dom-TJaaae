...
allHrsArray.map((elem)=>elem.style.backgroundColor="antiquewhite");
...
imageArray.map((elem)=>elem.style.border="2px solid purple");
// Hide the box number 17 (last box).
let seventeen = document.querySelector(".seventeen");
seventeen.style.display="none";
// Change the border of all the hr element from solid to dashed type
allHrsArray.map((elem)=>elem.style.border="1px dashed tomato");
